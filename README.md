...
```
cd existing_repo
git remote add origin https://gitlab.pg.innopolis.university/n.solomennikov/choosetwooption.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.pg.innopolis.university/n.solomennikov/choosetwooption/-/settings/integrations)
